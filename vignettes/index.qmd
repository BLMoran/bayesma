...
The **bayesma** package implements a range of Bayesian meta-analysis models
for synthesizing evidence across studies.
...
Each article below explains the statistical model, its assumptions, and how it works.
