---
title: "Stan code — Bias-adjusted model (Jung & Aloe 2026)"
vignette: >
  %\VignetteIndexEntry{stan-bias-adjusted-jung}
...
See [Bias-adjusted models (Jung & Aloe 2026)](bias-corrected-jung-verde.html) for the full statistical rationale.
