...
1. Fit PET. If the PET intercept $\alpha$ is clearly different from zero (95% CI excludes 0), proceed to PEESE.
...
For a more comprehensive approach that models multiple sources of bias simultaneously, see [Robust Bayesian Meta-Analysis (RoBMA)](robma.html), which averages over PET-PEESE and selection model assumptions.
