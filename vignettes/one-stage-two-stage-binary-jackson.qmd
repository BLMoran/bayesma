...
See [Gaussian Random-Effects Model](common-effect-random-effect.html) for full details.
...
These match the defaults for the two-stage model. See [Prior Predictive Checks](prior-predictive-checks.html) for outcome-specific guidance.
