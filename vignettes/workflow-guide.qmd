...
9. **Bias Assessment** — Detect and adjust for publication/reporting bias
10. **Subgroup & Moderation Analysis** — Explore effect modification (meta-regression)
11. **Sensitivity Analysis** — Assess robustness to modeling choices
12. **Interpretation & Reporting** — Summarize findings and communicate uncertainty
