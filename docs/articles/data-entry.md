...
> **First load takes ~30 seconds** while your browser downloads the R
> runtime (WebAssembly). No server is required — everything runs
> locally.
>
> Prefer a desktop experience? Run
> [`bayesma::launch_data_entry()`](https://blmoran.github.io/bayesma/reference/launch_data_entry.md)
> in your R session to open the same app in a browser window.
