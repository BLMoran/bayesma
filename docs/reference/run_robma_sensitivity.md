...
#> Error: object 'my_robma_fit' not found
...
#> 
#> ── Running RoBMA sensitivity analysis ──
#> 
#> ℹ Fitting 2 RoBMA models across prior specifications
#> ℹ Running in parallel mode with auto workers
