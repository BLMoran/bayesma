...
# bayesma: Bayesian Meta Analyses <img src="man/figures/logo.png" align="right" width="200" />
...
| `overall_plot()` | Posterior densities for μ, τ, and predictive distribution |
| `funnel_plot()` | Funnel plot for visual bias assessment |
| `sensitivity_plot()` | Leave-one-out influence diagnostics |
| `ecdf_plot()` | Empirical CDF of posterior draws |
| `rob_plot()` | Risk of bias summary (RoB2, ROBINS-I, ROBINS-E, QUADAS-2) |
...
Available distributions: `normal()`, `half_normal()`, `half_cauchy()`,
`half_student_t()`, `exponential()`, `uniform()`, `beta()`,
`dirichlet()`.
...
[here](https://github.com/BLMoran/bayesma/issues) with a minimal code
