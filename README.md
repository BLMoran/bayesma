...
<!-- workflow diagram below (rendered via the pkgdown site) -->

\#[![Workflow
diagram](man/figures/workflow-diagram.png)](https://blmoran.github.io/bayesma/articles/workflow-guide.html)
